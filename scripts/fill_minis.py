...
SYSTEM_PROMPT = (
    ...
    "For vehicles and monsters/characters with no explicit count stated, use these equivalents:\n"
    "- 2 for generic special characters (single unnamed/generic heroes)\n"
    "- 3 for named special characters or named monsters\n"
    "- 4 for big monsters or small vehicles (car-sized)\n"
    "- 6 for truck-sized vehicles\n"
    "- 8 for tank-sized vehicles\n"
