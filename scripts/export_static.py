"""
Export DB to static/data.json for static hosting.

index.html and static/ are already in the repo root — just run this to
regenerate data.json, then serve the repo root with any HTTP server.
